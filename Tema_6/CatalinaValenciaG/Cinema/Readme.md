...
| POST                                   | /salas                 | N/A          | `{"Name": "A1", "quantityCols": 4, "quantityRows": 4}`                     | `{"salaId": 100, "Name": "A1", "quantityCols": 4, "quantityRows": 4}`             | 201 Created<br/>400 Bad Request<br/>500 Internal Server Error |
...
| POST                                   | /reservations                 | N/A          | `{"userId": 14566, "salaId": 100, "Date": "2024-01-5", "cost": "$12.000", "status": "pending payment"}`               | `{"reservationId": 1000, "userId": 14566, "salaId": 100, "Date": "2024-01-5"}`             | 201 Created<br/>400 Bad Request<br/>500 Internal Server Error |
