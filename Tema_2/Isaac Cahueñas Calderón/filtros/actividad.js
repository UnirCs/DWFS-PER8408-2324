...
function redConverter() {
    ...
    let nuevaFila = [];
    let pixel = [];
    pixels.forEach(function (numero) {
        numero.forEach(function (numero2) {
            pixel = [numero2[0], 0, 0];
            nuevaFila.push(pixel);
            pixel = [];
...
function greyConverter() {
    ...
    pixels.forEach(function (numero) {
        numero.forEach(function (numero2) {
            let a =(numero2[0]+numero2[1]+numero2[2])/3
            pixel = [ a, a,a];
            nuevaFila.push(pixel);
            pixel = [];
...
function blackAndWhiteConverter() {
    ...
    pixels.forEach(function (numero) {
        numero.forEach(function (numero2) {
            let a =(numero2[0]+numero2[1]+numero2[2])/3<128?0:255;
            pixel = [ a, a,a];
            nuevaFila.push(pixel);
            pixel = [];
...
function dimBrightness(dimFactor) {
    ...
    pixels.forEach(function (numero) {
        numero.forEach(function (numero2) {
            ...
            pixel = [numero2[0]/dimFactor,numero2[1]/dimFactor,numero2[2]/dimFactor];
            nuevaFila.push(pixel);
            pixel = [];
...
function invertColors() {
    ...
    pixels.forEach(function (numero) {
        numero.forEach(function (numero2) {
            ...
            pixel = [255-numero2[0],255-numero2[1],255-numero2[2]];
            nuevaFila.push(pixel);
            pixel = [];
...
function merge(alphaFirst, alphaSecond) {
    ...
    let nuevaFila = [];
    let pixel = [];
    catPixels.forEach(function (numero) {
        numero.forEach(function (numero2) {
            let pixelMultiplicado =[numero2[0]*alphaFirst,numero2[1]*alphaFirst,numero2[2]*alphaFirst];
            pixel = [pixelMultiplicado[0]+pixelMultiplicado[1]+pixelMultiplicado[2],pixelMultiplicado[0]+pixelMultiplicado[1]+pixelMultiplicado[2],pixelMultiplicado[0]+pixelMultiplicado[1]+pixelMultiplicado[2]];
            nuevaFila.push(pixel);
            pixel = [];
