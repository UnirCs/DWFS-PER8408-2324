...
function blackAndWhiteConverter() {
  ...
  for(let fila=0; fila < pixels.length; fila ++){
    for(let columna = 0; columna < pixels[fila].length; columna ++){
      ...
      pixels[fila][columna][0] = valor;
      pixels[fila][columna][1] = valor;
      pixels[fila][columna][2] = valor;
    }
  }
...
function merge(alphaFirst, alphaSecond) {
  ...
  for(let fila=0; fila < catPixels.length; fila ++){
      ...
      for(let columna = 0; columna < catPixels[fila].length; columna ++){
          let colorPixel = [];
          colorPixel[0] = dogPixels[fila][columna][0]*alphaFirst +  (catPixels[fila][columna][0]*alphaSecond);
          colorPixel[1] = dogPixels[fila][columna][1]*alphaFirst +  (catPixels[fila][columna][1]*alphaSecond);
          colorPixel[2] = dogPixels[fila][columna][2]*alphaFirst +  (catPixels[fila][columna][2]*alphaSecond);
          nuevaFila.push(colorPixel);
      }
      mergeImage.push(nuevaFila);
  }

  dogHandler.savePixels(mergeImage, outputPath);
