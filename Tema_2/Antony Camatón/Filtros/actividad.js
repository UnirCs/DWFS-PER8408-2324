...
function greyConverter() {
 ...
 for (let i=0; i<filas; i++){
   ...
   for(let j=0; j<col; j++){
     ...
     let pixel = [pixels[i][j][0],pixels[i][j][1],pixels[i][j][2]];
...
function merge(alphaFirst, alphaSecond) {
  ...
  for (let i=0; i<filas; i++){
    ...
    for(let j=0; j<col; j++){
      ...
      let pixel_R = (dogPixels[i][j][0]*alphaFirst)+(catPixels[i][j][0]*alphaSecond);
      let pixel_G = (dogPixels[i][j][1]*alphaFirst)+(catPixels[i][j][1]*alphaSecond);
      let pixel_B = (dogPixels[i][j][2]*alphaFirst)+(catPixels[i][j][2]*alphaSecond);


      let pixel = [pixel_R, pixel_G, pixel_B];
      nuevaFila.push(pixel);
    }
