...
function redConverter() {
    ...
    for(let posFila in pixels){
        for(let posCol in pixels[posFila]){
            let pixel = pixels[posFila][posCol];
            pixel[1] = 0;
            pixel[2] = 0;
        }
    }
...
function merge(alphaFirst, alphaSecond) {
    ...
    let pixels = [];
    for(let posFila in catPixels){
        let fila = [];
        for(let posCol in catPixels[posFila]) {
            let pixel =   [0, 0, 0];
            pixel[0] = catPixels[posFila][posCol][0] * alphaSecond + dogPixels[posFila][posCol][0] * alphaFirst;
            pixel[1] = catPixels[posFila][posCol][1] * alphaSecond + dogPixels[posFila][posCol][1] * alphaFirst;
            pixel[2] = catPixels[posFila][posCol][2] * alphaSecond + dogPixels[posFila][posCol][2] * alphaFirst;
            fila.push(pixel);
        }
        pixels.push(fila);
    }
