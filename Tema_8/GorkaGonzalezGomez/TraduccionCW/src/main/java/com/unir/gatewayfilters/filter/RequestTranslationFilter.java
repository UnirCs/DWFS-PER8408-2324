package com.unir.gatewayfilters.filter;

import com.unir.gatewayfilters.decorator.RequestDecoratorFactory;
import com.unir.gatewayfilters.model.GatewayRequest;
import com.unir.gatewayfilters.utils.RequestBodyExtractor;
...
public class RequestTranslationFilter implements GlobalFilter {
     ...
     * If the request does have a content typr and is a POST request, the body of the request is joined into a single DataBuffer.
