...
public class GetRequestDecorator extends ServerHttpRequestDecorator {
    ...
    /**
     * This method overrides the getBody mehtod of the ServerHttpRequestDecorator class.
     * Since GET request do not have a body, it returns an empty Flux of DataBuffers.
     */
    @Override
    @NonNull
