...
document.getElementById('userForm').addEventListener('submit', (event) => {
    ...
    if (errorMessages.length === 0) {
        ...
        // El motivo de usar replace en lugar de href es porque no queremos que el usuario esté haciendo
        // click hacia atrás en el navegador y registrándose en múltiples oportunidades.
