...
const validatePassword = () => {
    ...
    if (!passwordRegex.test(password)) {
        createErrorMessage('password', 'La contraseña debe tener mínimo 6 caracteres, contener números, al menos una letra mayúscula y un carácter especial.');
    } else {
...
// Validar el campo de email con el formato correcto
const validateEmail = () => {
...
document.getElementById('userForm').addEventListener('submit', (event) => {
    ...
    if (errorMessages.length === 0) {
        ...
        //Usamos el replace ya que al tratarse de un registro si el usuario logra registrarse queremos que la pagina se reemplaze y no pueda volver atras
        //Esto puede mejorar la experiencia del usuario, ya que no tiene sentido volver a la página de registro una vez que el usuario ha iniciado sesión.
