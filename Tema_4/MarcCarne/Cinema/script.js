...
document.getElementById('userForm').addEventListener('submit', (event) => {
    ...
    // Redirigir a la página de cinema
    // Permitiría volver atrás por lo que no creo que sea adecuado para una página de validación
    //location.href = "./cinema.html";

    // Método replace: no se puede volver a la página anterior
    // Eso es porque no añade al historial la nueva página y simplemente carga el nuevo contenido
    // Sería la que hay que usar en este caso
