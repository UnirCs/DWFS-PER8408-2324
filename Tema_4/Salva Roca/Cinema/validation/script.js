// Funciones a ejecutar cuando el DOM esté completamente cargado
...
document.getElementById('userForm').addEventListener('submit', (event) => {
    ...
    if (errorMessages.length === 0) {
        // Si no hay errores, se puede procesar el formulario y redirigir a la página de reserva de asientos
