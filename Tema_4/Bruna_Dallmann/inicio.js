...
document.getElementById('userForm').addEventListener('submit', (event) => {
    ...
    if (errorMessages.length === 0) {
        ...
        window.location.replace('http://localhost:63342/Tema4/index.html?_ijt=hr4e46374nenis3cj3rg8jkola');
        /*El método window.location.href cambia la ubicación de la página actual y agrega una nueva entrada al historial
         del navegador, mientras que el window.location.replace no. Para este último, si el usuario hace clic en el
         botón "atrás" en el navegador, no volverá a la página de registro, sino que saldrá del sitio web si no hay
         más entradas en el historial. Entiendo que en este caso lo ideal sería no poder volver a la página de registros
         una vez que el usuario ya se haya registrado.*/
    } else {
