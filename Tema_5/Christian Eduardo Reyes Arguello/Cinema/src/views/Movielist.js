...
export const Movielist = () => {
    const movies =
        [
            ...
            },
            {
                ...
                "overview": "Cuando una camioneta de traslado de prisioneros es atacada, el policía a cargo debe luchar contra los que están dentro y fuera mientras se enfrenta a un enemigo silencioso: las gélidas temperaturas.",
                "popularity": 1813.556,
    ...
    return (
        <div>
            <Header />
            <h2 className="center-text">Cartelera para HOY</h2>
